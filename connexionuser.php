 ...
 <form action="requeteuser.php" method="post" id="dedans">
		<div class="form-group">
			...
			<div id="usercss">
					...
					<p>
					<input class="admin" type="password" placeholder="administrateur" name="mdp" class="form-control input-lg" required></p>
					</input>
				<div class="btn-group">
							<button type="submit" class="btn btn-success" name="valide" value="1" onclick="return confirm('Voulez vous vous connecter?');">Connexion</button>
							<button  type='submit' class='btn btn-danger' name="inscription" value="2"><a href="inscription.php">Inscription</a></button>	
				</div>
			</div>
	 </div>	
 </form>
